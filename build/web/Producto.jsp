            ...
            <table class="table table-horver">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>${prd.getEstado()}</td>
                        <td>
                            <a class="btn btn-warning" href="Controlador?menu=Producto&accion=Editar&id=${prd.getId()}">Editar</a>
                            <a class="btn btn-danger" href="Controlador?menu=Producto&accion=Delete&id=${prd.getId()}">Delete</a>
